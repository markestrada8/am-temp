...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://alexismcintosh.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://alexismcintosh.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id
                    }`,
                apiAction: "patch"
            })
        }
    ...
    handleSubmit(event) {
        axios({
            ...
            .then(response => {
                if (this.state.featured_image) {
                    // console.log(this.featuredImageRef.current)
